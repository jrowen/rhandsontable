...
It's also possible to define a custom column renderer function.  For example, it may be desirable to include html in a cell.  The example below mimics [Custom renderers](https://handsontable.com/docs/4.0.0/demo-custom-renderers.html).
