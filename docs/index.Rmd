...
The `language` parameter for `hot_col` can be used to change the locale.  See the [numbro.js](http://numbrojs.com/) library for language options.

```{r}
DF = data.frame(dollar = rnorm(10), euro = rnorm(10), yen = rnorm(10))

rhandsontable(DF * 1000, width = 550, height = 300, language = "pl-PL") %>%
